	...
	<a href="<?php bloginfo('url'); ?>"><img src="<?php echo $image[0]; ?>"></a>
						...
						<div class="right-field col-md-4">
							...
							<div class="contact">
								...
								<h4><i class="fa fa-envelope-o"></i><a href="mailto:<?php the_field('email', 4); ?>"><?php the_field('email', 4); ?></a></h4>

								<h4><i class="fa fa-phone-square"></i>0176-169 85</h4>

								<h4><i class="fa fa-phone-square"></i>Jörgen: 0706-92 90 07  </h4>

								<h4><i class="fa fa-phone-square"></i>Micke: 0706-76 71 01</h4>
